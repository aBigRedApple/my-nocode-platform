/*
  ...
  - You are about to drop the column `projectId` on the `component` table. All the data in the column will be lost.
  - You are about to drop the `project` table. If the table is not empty, all the data it contains will be lost.

*/
-- DropIndex
DROP INDEX `Component_projectId_idx` ON `component`;

-- AlterTable
ALTER TABLE `component` DROP COLUMN `projectId`;
